...
function addLights() {
  ...
  const ambientLight2 = new THREE.AmbientLight(0xff0c72, 0.2);
  const light1 = new THREE.PointLight(0x9FE7F5, 0.4, 100);
  light1.position.set(30, 0, 10);
  const light2 = new THREE.PointLight(0xA3C3FF, 0.4, 100);
